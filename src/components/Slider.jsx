  ...
  <div className="parentdiv h-[540px] bg-white flex items- center justify-between">
    ...
    {slides.map((slide,index)=>{
      if(index===activeSlide){
        return(
          <div className={`wrapper flex w-[100%] h-[500px] justify-center items-center shadow-2xl rounded-lg border-[#c0c0c0] border-10px
    ...
    <div className="slide flex items-center justify-center h-[100%]">
      ...
      <div className="des flex flex-col flex-1 place-items-start justify-center m1-11">
